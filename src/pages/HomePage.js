...
const HomePage = () => {
    ...
    const filteredProduct = async () => {
        try {
            //api calll
            const { data } = await axios.post('https://furniturefusion-mern.onrender.com/api/v1/product/product-filters', { checked, radio })
    ...
    const getAllProducts = async () => {
        try {
            setLaoding(true)
            const { data } = await axios.get(`https://furniturefusion-mern.onrender.com/api/v1/product/product-list/${page}`)
            setLaoding(false)
    ...
    const getTotal = async () => {
        try {
            const { data } = await axios.get('https://furniturefusion-mern.onrender.com/api/v1/product/product-count')
            setTotal(data?.total)
